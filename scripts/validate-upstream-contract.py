...
required_config_markers = [
    ...
    'dig "runtimeConfig" "maxmemory" "1536mb" .Values.redis',
    'dig "runtimeConfig" "maxmemoryPolicy" "noeviction" .Values.redis',
    'dig "runtimeConfig" "replBacklogSize" "64mb" .Values.redis',
    'dig "runtimeConfig" "clusterNodeTimeout" 15000 .Values.redis',
    "appendfsync ",
    "cluster-enabled yes",
    "# tls-cluster yes",
